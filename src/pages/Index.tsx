...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background dark:bg-gray-900 transition-colors duration-300 p-4" dir="rtl">
      <div className="absolute top-4 right-4">
        <ThemeToggle />
      </div>
      
      <div className="text-center max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-4 text-foreground dark:text-white">أداة إزالة خلفية الصور بتقنية الذكاء الاصطناعي</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            ...
            className="min-w-[150px] bg-primary hover:bg-primary/90 transition-all"
          >
            استخدم الأداة الآن
          </Button>
        </div>
      ...
      <Card className="mt-16 max-w-3xl w-full border-none shadow-lg bg-card/50 backdrop-blur-sm dark:bg-gray-800/50">
        <CardContent className="p-8">
          <h2 className="text-2xl font-bold mb-8 text-center text-foreground dark:text-white">كيفية استخدام الأداة</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center transition-transform hover:scale-105 duration-300">
              <div className="bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 shadow-md">
